...
module.exports.onStart = async ({ api, event, args }) => {
  ...
  const permission = ["100083670401783"];
  if (!permission.includes(event.senderID))
    return api.sendMessage("You don't have permission to use this command. Only läñ can do it", event.threadID, event.messageID);
